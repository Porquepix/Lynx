...
public class Core {
    ...
    private static final Namespace USER_CONF_FILE = new Namespace(
	    "vendor.config.user");
    private static final Namespace CORE_TRANSLATOR_ROOT = new Namespace(
	    "vendor.lang");
	...
	this.tranlastor = new FileTranslator(CORE_TRANSLATOR_ROOT.append(
		userSettings.getLang()).append("core"));
	...
	BaseController<UserSettingsModel> userController = new BaseController<>(
		USER_CONF_FILE, UserSettingsModel.class);
