...
public class BaseControllerTest {
    ...
    private BaseController<GameInfoModel> controller1 = new BaseController<>(testFile1, GameInfoModel.class);
    private BaseController<AppSettingsModel> controller2 = new BaseController<>(testFile2, AppSettingsModel.class);
    private BaseController<GameInfoModel> controller3 = new BaseController<>(testFile3, GameInfoModel.class);
